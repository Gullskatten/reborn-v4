...
var zoom_level : Vector2 = DEFAULT_ZOOM : set = set_zoom_level
var camera_position : Vector2 = Vector2(0,0) : set = set_camera_position
var is_inside := false : set = set_is_inside
var is_locked := false
